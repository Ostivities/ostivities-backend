                 ...
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                   <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="left" class="es-text-3208" style="padding:0;Margin:0;padding-top:20px;padding-bottom:15px"><p class="es-text-mobile-size-14" style="Margin:0;mso-line-height-rule:exactly;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';line-height:26.6px !important;letter-spacing:0;color:#333333;font-size:14px;text-align:justify">
                     </tr>
                     
                     <tr>
                      <td align="justify" style="padding:0;Margin:0;padding-top:10px;padding-bottom:20px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';line-height:26.6px !important;letter-spacing:0;color:#333333;font-size:14px;text-align:justify">You have been invited has a ticketing agent for <span style="font-style: normal; font-weight: bold; color: #E20000;">${event_name}</span> event. Kindly find attached your login credentials to the event ticket scanning platform below and please do not share with a 3rd party: </p><p style="Margin:0;mso-line-height-rule:exactly;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';line-height:26.6px !important;letter-spacing:0;color:#333333;font-size:14px;text-align:justify"> </p><p style="Margin:0;mso-line-height-rule:exactly;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';line-height:26.6px !important;letter-spacing:0;color:#333333;font-size:14px;text-align:justify"><p style="font-size: 14px;">- Email: 
  <span style="font-style: normal; font-weight: bold; color: #E20000; font-size: 14px;">${staff_email}</span>
</p>
<p style="font-size: 14px;">- Password: 
  <span style="font-style: normal; font-weight: bold; color: #E20000; font-size: 14px;">${password_text}</span>
</p>
<p style="font-size: 14px;">- Scanner Link: 
  <a href="https://scanner.ostivities.com/" style="font-style: normal; font-weight: bold; color: #E20000; text-decoration: none;">https://scanner.ostivities.com</a>
</p>

 </p>
<p style="Margin:0;mso-line-height-rule:exactly;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';line-height:26.6px !important;letter-spacing:0;color:#333333;font-size:14px;text-align:justify">If you have any issues or questions about this mail, please contact the organizer at <span style="font-style: normal; font-weight: bold; color: #E20000;"> ${host_email}</span>
</p></td>
                    <tr>
